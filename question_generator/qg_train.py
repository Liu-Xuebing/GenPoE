...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--qg_model", type=str, default="google/flan-t5-large")
    parser.add_argument("--pad_mask_id", type=int, default=-100)
    parser.add_argument("--pin_memory", dest="pin_memory", action="store_true", default=False)
    parser.add_argument("--save_dir", type=str, default="./checkpoints/hotpot")
...
def get_model(checkpoint: str, device: str, tokenizer: T5Tokenizer) -> T5ForConditionalGeneration:
    ...
    model = T5ForConditionalGeneration(config).from_pretrained(checkpoint, device_map="auto")
...
if __name__ == "__main__":
    ...
    with open('./datasets/hotpot_dataset.json', 'r') as f:
        dataset = json.load(f)

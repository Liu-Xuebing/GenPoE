        ...
        for doc, sentence in zip(docs, sentences):
            ...
            if entities:
                for entity in entities:
                    qg_input = "Generate a question with <answer> as '{}' from the <context>: {}".format(entity, sentence)
...
class QAEvaluator:
    """Wrapper for a transformer MOE_model which evaluates the quality of question-answer pairs.
    Given a QA pair, the MOE_model will generate a score. Scores can be used to rank and filter
    QA pairs.
    """

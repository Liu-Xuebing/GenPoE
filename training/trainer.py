...
class Trainer:
    def __init__(
        ...
        self.scheduler = CosineAnnealingLR(self.optimizer, eta_min=1e-6, T_max=epochs)  # T_max为一个完整周期的epoch数
    ...
    def train(self) -> None:
        for epoch in range(1, self.epochs+1):
            ...
            with tqdm(total=len(self.train_loader), unit="batches") as tepoch:
                print(f"Epoch {epoch}, Learning Rate: {self.scheduler.get_last_lr()[0]}")
